...
$("#delete-btn").click((event) => {
    ...
    let result = window.confirm("Jika menghapus arsip ini, maka data peminjaman, pengembalian, dan lampiran dari arsip ini juga akan terhapus.");
    if (result) {
        window.location = '<?= base_url("arsip/hapusarsip/$dataArsip->id_arsip") ?>';
    }
});
</script>