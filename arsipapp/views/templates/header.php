    ...
    <nav class="nav">
        <div class="nav-container">
            ...
            <div class="logo-container" id="logo-container">
                <div class="logo" style="background: center center/contain url(<?= base_url('/assets/images/logo.png') ?>);"></div>
            </div>
            ...
            ?>
                <div class="user-profile" id="user-profile">
                    <div class="user-avatar" style="background: center center/cover no-repeat url(<?= base_url('/assets/images/user.png') ?>);"></div>
